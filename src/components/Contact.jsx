    ...
    <Fragment>
      <div id="contact" className="row justify-content-center py-5">
        <form className="form__about col-12 col-md-6 p-5" onSubmit={sendEmail}>
          ...
          <div className="mb-3" >
            <label htmlFor="name" className="form-label text-muted">Name and Email:</label>
            <input type="text" name="to_name" id="name" className="form-control" placeholder="Your name and your email" />
          </div>
